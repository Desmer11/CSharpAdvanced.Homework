...
namespace Class07.Task01.FilterCars
{
    public class Car
    {
        ...
        {
            return $"Car: {Model} === ORIGIN:  {Origin} ===" +
                $" Cylinders {Cylinders} === {HorsePower} ";
    ...
    public static class CarsData
    {
        ...
        public static void LoadCars()
        {
            Cars = new List<Car>()
           {
             ...
             new Car() { Model = "BMW 320i", MilesPerGalon = 215, AccelerationTime = 12.8, Cylinders = 4, HorsePower = 110, Origin = "Europe", Weight = 2600 },
             ...
             new Car() { Model = "Honda Civic CVCC", MilesPerGalon = 361, AccelerationTime = 16.4, Cylinders = 4, HorsePower = 60, Origin = "Japan", Weight = 1800 },
